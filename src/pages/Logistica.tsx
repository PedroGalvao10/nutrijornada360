...
export default function Logistica() {
  ...
  return (
    <main className="max-w-7xl mx-auto px-6 py-12 pt-32 bg-background">
      <SEO 
      ...
      <StaggerReveal>
        <header className="mb-20 text-center max-w-3xl mx-auto">
          <StaggerItem>
            <h1 className="text-4xl md:text-5xl font-bold text-primary mb-6 leading-tight font-headline">Logística e Agendamento</h1>
          </StaggerItem>
          <StaggerItem>
            <p className="text-lg text-secondary leading-relaxed font-body">Sua jornada rumo ao bem-estar começa aqui. Entenda como funcionam nossos atendimentos e prepare-se para uma transformação completa.</p>
          </StaggerItem>
        </header>
      </StaggerReveal>
      ...
      <section className="mb-24">
        <StaggerReveal staggerInterval={0.15}>
          <div ref={onlineRef} className="bg-surface-container-low p-10 md:p-12 rounded-2xl flex flex-col lg:flex-row gap-12 items-center shadow-[0_4px_24px_rgba(46,50,48,0.06)] transform-style-3d">
            <div className="flex-1 tilt-child tz-10">
              <StaggerItem>
                <div className="flex items-center gap-2 mb-4">
                  <span className="material-symbols-outlined text-primary text-4xl">public</span>
                  <h2 className="text-3xl font-bold text-on-surface font-headline">Consulta Online</h2>
                </div>
              </StaggerItem>
              <StaggerItem>
                <p className="text-secondary mb-8 leading-relaxed font-body text-lg">Perfeita para quem busca praticidade sem perder a profundidade do atendimento presencial. Descubra os benefícios exclusivos da nossa plataforma digital:</p>
              </StaggerItem>
      ...
      {/* Preparação Section */}
      <section ref={prepRef} className="bg-surface-container-highest rounded-xl overflow-hidden mb-24 transform-style-3d">
        <StaggerReveal className="flex flex-col md:flex-row items-stretch" amount={0.2}>
          <div className="w-full md:w-1/2 p-12 tilt-child tz-10">
            <StaggerItem>
              <h2 className="text-3xl font-bold text-primary mb-8 font-headline">O Caminho da Preparação</h2>
            </StaggerItem>
            <div className="space-y-8">
              <StaggerItem>
                <div className="flex gap-4 group">
                  ...
                  <div>
                    <h3 className="font-bold text-lg font-headline">Fechamento do Plano</h3>
                    <p className="text-secondary font-body">Após escolher o melhor formato online para você, confirmamos seu horário.</p>
                  </div>
                </div>
              </StaggerItem>
              <StaggerItem>
                <div className="flex gap-4 group">
                  ...
                  <div>
                    <h3 className="font-bold text-lg font-headline">Formulário Pré-Consulta</h3>
                    <p className="text-secondary font-body">Você receberá um formulário online de rotina. Ele é fundamental para que eu entenda o histórico do seu metabolismo e seus gatilhos antes do encontro.</p>
                  </div>
                </div>
              </StaggerItem>
              <StaggerItem>
                <div className="flex gap-4 group">
                  ...
                  <div>
                    <h3 className="font-bold text-lg font-headline">Personalização Total</h3>
                    <p className="text-secondary font-body">Com a sua base de dados, chego na nossa sessão já sendo direta e certeira no que precisamos adaptar na sua alimentação.</p>
                  </div>
                </div>
              </StaggerItem>
            </div>
          </div>
          <div className="w-full md:w-1/2 bg-primary-container/20 flex items-center justify-center p-12 tilt-child tz-30">
            <StaggerItem direction="left">
              <div className="bg-surface p-8 rounded-lg shadow-sm max-w-sm rotate-2 tilt-child tz-40">
                ...
                <div className="h-2 w-full bg-surface-container-highest rounded mb-2"></div>
                <div className="h-2 w-full bg-surface-container-highest rounded mb-2"></div>
                <div className="h-2 w-2/3 bg-surface-container-highest rounded mb-6"></div>
                <div className="flex gap-2">
                  <div className="h-4 w-4 bg-primary/40 rounded-sm"></div>
                  <div className="h-2 w-12 bg-surface-container-highest rounded mt-1"></div>
                </div>
              </div>
            </StaggerItem>
          </div>
      ...
      <section ref={ctaRef} className="mb-24">
        <StaggerReveal>
          <div className="bg-primary text-on-primary rounded-[2rem] p-12 text-center relative overflow-hidden transform-style-3d">
            ...
            <div className="relative z-10 tilt-child tz-10">
              <StaggerItem>
                <h2 className="text-3xl font-bold mb-6 font-headline">Pronta para começar sua NutriJornada?</h2>
              </StaggerItem>
              <StaggerItem>
                <p className="mb-10 text-on-primary-container max-w-xl mx-auto opacity-90 font-body">Clique no botão abaixo para falar com a equipe de atendimento via WhatsApp e encontrar o melhor horário para sua sessão inicial.</p>
              </StaggerItem>
              <StaggerItem>
                <a className="inline-flex items-center gap-3 bg-surface text-primary px-8 py-4 rounded-full font-bold text-lg hover:scale-105 hover:shadow-xl transition-all shadow-lg tilt-child tz-30" href="https://wa.me/5511956007142?text=Ol%C3%A1%2C%20Mariana!%20Gostaria%20de%20saber%20mais%20sobre%20a%20consulta%20ou%20agendar%20um%20atendimento." target="_blank" rel="noopener noreferrer">
